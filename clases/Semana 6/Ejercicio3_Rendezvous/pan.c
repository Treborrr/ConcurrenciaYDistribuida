...
iniglobals(int calling_pid)
{
		j1_en_fase2 = 0;
		j2_en_fase2 = 0;
		now.j1_llego_control = 0;
		now.j2_llego_control = 0;
		now.j1Llego = 0;
		now.j2Llego = 0;
#ifdef VAR_RANGES
		logval("j1_llego_control", now.j1_llego_control);
		logval("j2_llego_control", now.j2_llego_control);
		logval("j1Llego", now.j1Llego);
		logval("j2Llego", now.j2Llego);
#endif
}
...
{	/* int i; */
	printf("global vars:\n");
	printf("	byte   j1Llego:	%d\n", now.j1Llego);
	printf("	byte   j2Llego:	%d\n", now.j2Llego);
	printf("	bit    j1_llego_control:	%d\n", now.j1_llego_control);
	printf("	bit    j2_llego_control:	%d\n", now.j2_llego_control);
}
void
