...
#define _nstates1	6	/* :init: */
#define minseq1	46
#define maxseq1	50
#define _endstate1	5

#define _nstates0	47	/* Trabajador */
#define minseq0	0
#define maxseq0	45
...
#define PTrabajador	((P0 *)_this)
typedef struct P0 { /* Trabajador */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, f) - 1*sizeof(uchar))
