...
short src_ln0 [] = {
	  0,  22,  23,  26,  26,  26,  27,  29, 
	 30,  30,  30,  31,  32,  32,  28,  34, 
	 34,  37,  37,  37,  38,  41,  41,  41, 
	 42,  44,  45,  45,  45,  46,  47,  47, 
	 43,  49,  49,  52,  52,  52,  53,  55, 
	 56,  57,  57,  21,  59,  21,  59,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "barrier.pml", 1, 46 },
	{ "-", 47, 48 }
...
{	int j = 0, h = now._nr_pr;
	...
	case 0:	/* Trabajador */
		...
		((P0 *)pptr(h))->f = 0;
#ifdef VAR_RANGES
		logval("Trabajador:id", ((P0 *)pptr(h))->id);
		logval("Trabajador:f", ((P0 *)pptr(h))->f);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
iniglobals(int calling_pid)
{
		...
		logval("mut", now.mut);
		logval("molinete1", now.molinete1);
		logval("molinete2", now.molinete2);
#endif
}
...
{	/* int i; */
	...
	printf("	byte   count:	%d\n", now.count);
	printf("	byte   mut:	%d\n", now.mut);
	printf("	byte   molinete1:	%d\n", now.molinete1);
	printf("	byte   molinete2:	%d\n", now.molinete2);
}
void
...
{	/* int i; */
	...
	case 1:
		...
		break;
	case 0:
		printf("local vars proc %d (Trabajador):\n", pid);
	printf("	byte   id:	%d\n", ((P0 *)pptr(pid))->id);
	printf("	byte   f:	%d\n", ((P0 *)pptr(pid))->f);
		break;
	}
