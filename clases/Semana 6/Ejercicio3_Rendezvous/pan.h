...
#define PanSource	"rendezvous.pml"
...
#define _nstates1	11	/* Jugador_2 */
#define minseq1	10
#define maxseq1	19
#define _endstate1	10

#define _nstates0	11	/* Jugador_1 */
#define minseq0	0
#define maxseq0	9
...
#define PJugador_2	((P1 *)_this)
typedef struct P1 { /* Jugador_2 */
...
#define PJugador_1	((P0 *)_this)
typedef struct P0 { /* Jugador_1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	#endif
#endif
	unsigned j1_llego_control : 1;
	unsigned j2_llego_control : 1;
	uchar j1Llego;
	uchar j2Llego;
#ifdef TRIX
...
#define HAS_TRACK	0
/* hidden variable: */	uchar j1_en_fase2;
/* hidden variable: */	uchar j2_en_fase2;
