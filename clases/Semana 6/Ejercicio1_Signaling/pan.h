...
#define PanSource	"signaling.pml"
...
#define _nstates1	7	/* Proceso_B */
#define minseq1	5
#define maxseq1	10
#define _endstate1	6

#define _nstates0	6	/* Proceso_A */
#define minseq0	0
#define maxseq0	4
#define _endstate0	5
...
#define PProceso_B	((P1 *)_this)
typedef struct P1 { /* Proceso_B */
...
#define PProceso_A	((P0 *)_this)
typedef struct P0 { /* Proceso_A */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 4; /* state    */
#ifdef HAS_PRIORITY
